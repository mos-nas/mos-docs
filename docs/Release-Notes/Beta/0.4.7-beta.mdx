...
:::tip[Download]
Download this release on the [GitHub Releases](https://github.com/mos-nas/mos-releases/releases/tag/0.4.7-beta) page.
:::
...
**← [Previous: 0.4.8-beta](./0.4.8-beta)** | [📋 Release Notes Overview](../Overview) | **[Next: 0.4.6-beta →](./0.4.6-beta)**

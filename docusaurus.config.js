    ...
    [
      '@docusaurus/plugin-client-redirects',
      {
        redirects: [
          ...
          { to: '/docs/Settings/Cron-Jobs', from: '/System_Management/Cron_Jobs' },
          { to: '/docs/Settings/Logs', from: '/System_Management/Logs' },
          ...
          { to: '/docs/Settings/Boot', from: '/System_Management/Boot' },
          ...
          { to: '/docs/Settings/Notify', from: '/System_Management/MOS_Notify' },
          { to: '/docs/Settings/Sensors', from: '/System_Management/Sensors' },
          { to: '/docs/Settings/System-Settings', from: '/System_Management/System' },
          { to: '/docs/Settings/Token', from: '/System_Management/Token' },
          ...
          { to: '/docs/Settings/Cron-Jobs', from: '/docs/System_Management/Cron_Jobs' },
          { to: '/docs/Settings/Logs', from: '/docs/System_Management/Logs' },
          ...
          { to: '/docs/Settings/Boot', from: '/docs/System-Management/Boot' },
          { to: '/docs/Settings/Cron-Jobs', from: '/docs/System-Management/System-Configuration/Cron-Jobs' },
          { to: '/docs/Settings/Logs', from: '/docs/System-Management/System-Configuration/Logs' },
          ...
          { to: '/docs/Settings/Notify', from: '/docs/System-Management/System-Configuration/Notify' },
          { to: '/docs/Settings/Sensors', from: '/docs/System-Management/System-Configuration/Sensors' },
          { to: '/docs/Settings/System-Settings', from: '/docs/System-Management/System-Configuration/System-Settings' },
          { to: '/docs/Settings/Token', from: '/docs/System-Management/System-Configuration/Token' },
          { to: '/docs/Settings/Update-System', from: '/docs/System-Management/System-Configuration/Update-System' },

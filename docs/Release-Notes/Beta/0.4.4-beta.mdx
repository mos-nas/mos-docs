...
# 0.4.4-beta
 ...
 :::tip Download
 Download this release on the [GitHub Releases](https://github.com/mos-nas/mos-releases/releases/tag/0.4.4-beta) page.
 :::
...
**← [Previous: 0.4.5-beta](./0.4.5-beta)** | [📋 Release Notes Overview](../Overview) | **[Next: 0.4.3-beta →](./0.4.3-beta)**

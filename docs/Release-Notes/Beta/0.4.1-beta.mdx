...
:::tip[Download]
Download this release on the [GitHub Releases](https://github.com/mos-nas/mos-releases/releases/tag/0.4.1-beta) page.
:::
...
**← [Previous: 0.4.2-beta](./0.4.2-beta)** | [📋 Release Notes Overview](../Overview) | **[Next: 0.4.0-beta →](./0.4.0-beta)**
